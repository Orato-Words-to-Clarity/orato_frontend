  ...
  return (
    <>
      ...
      <div className='min-h-screen bg-[#f0f1f1]'>
          ...
          <div className='grid items-center gap-8 md:grid-cols-2'>
            ...
            >
              ...
              <p className='text-lg text-gray-600 md:text-xl'>
                Transcribe your audio and interact with it using powerful AI-driven search and chat.
              </p>
        ...
        {/* Features Section */}
        <section ref={featuresRef} id='features' className='container mx-auto px-4 py-16 md:py-24'>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          <div className='grid gap-6 md:grid-cols-2 lg:gap-8'>
            {[
              ...
              },
              {
                ...
                description: 'Overcome usage limits by adding your own Groq and Hugging Face keys.',
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
